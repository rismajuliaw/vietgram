                ...
                <div class="photo">
                    <header class="photo__header">
                        ...
                        <div class="photo__user-info">
                            <span class="photo__author">amalkhai</span>
                            <span class="photo__location">Sukabirus</span>
                        </div>
                    </header>
                    ...
                    <div class="photo__info">
                        ...
                        <ul class="photo__comments">
                            ...
                            <span class="photo__comment-author">wardahanifah</span> dari google
                            </li>
                            <li class="photo__comment">
                            <span class="photo__comment-author">aliffrhn</span> :(
                            </li>
                            <li class="photo__comment">
                            <span class="photo__comment-author">amalkhai</span> hahahaha
                            </li>
                        </ul>
        ...
        ?>
            <div class="photo">
                <header class="photo__header">
                    <img src="images/avatar.jpg" class="photo__avatar" />
                    <div class="photo__user-info">
                        <span class="photo__author">rismajw</span>
                        <span class="photo__location">Braga</span>
                    </div>
                </header>
                <img src="upload/<?php echo $row['url'] ?>" />
                <div class="photo__info">
                    ...
                    <ul class="photo__comments">
                    <li class="photo__comment">
                            <span class="photo__comment-author">wardahanifah</span> kucing siapa?
                            </li>
                            <li class="photo__comment">
                            <span class="photo__comment-author">aliffrhn</span> :(
                            </li>
